...
export class ScreeningForCancerComponent implements OnInit {
  ...
  public psaImpactStudiesPlay(): void {
    this.psaImpactStudiesAudio.src = "/assets/audio/prostate-screening/screening/psa-impact-studies.mp3";
  ...
  public screeningForCancerPlay(): void {
    this.screeningForCancerAudio.src = "/assets/audio/prostate-screening/screening/screening-for-cancer.mp3";
