...
export class DiscussingResultsComponent implements OnInit {
  ...
  public densityPsaPlay(): void {
    this.densityPsaAudio.src = "/assets/audio/prostate-screening/steps/step-threee-density-psa.mp3";
  ...
  public discussingResultsPlay(): void {
    this.discussingResultsAudio.src = "/assets/audio/prostate-screening/steps/step-three-discussing-results.mp3";
  ...
  public freePsaAudioPlay(): void {
    this.freePsaAudio.src = "/assets/audio/prostate-screening/steps/step-threee-free-psa.mp3";
  ...
  public velocityPsaAudioPlay(): void {
    this.velocityPsaAudio.src = "/assets/audio/prostate-screening/steps/step-threee-velocity-psa.mp3";
