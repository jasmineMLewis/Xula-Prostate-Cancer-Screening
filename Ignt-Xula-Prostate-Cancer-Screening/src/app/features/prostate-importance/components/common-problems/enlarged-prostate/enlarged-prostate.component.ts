...
export class EnlargedProstateComponent implements OnInit {
  ...
  public enlargedProstatePlay(): void {
    this.enlargedProstateaAudio.src = "/assets/audio/prostate-importance/common-problems/enlarged-prostate.mp3";
  ...
  public urethraPlay(): any {
    this.urethraAudio.src = "/assets/audio/prostate-importance/common-problems/urethra.mp3";
