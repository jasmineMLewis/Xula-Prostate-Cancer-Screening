...
export class WatchAndWaitComponent implements OnInit {
  ...
  public psaDreBiopsyPlay(): void {
    this.psaDreBiopsyAudio.src = "/assets/audio/features/diagnosis-treatment/decision/psa-dre-biopsy.mp3";
  ...
  public watchAndWaitPlay(): void {
    this.watchAndWaitAudio.src = "/assets/audio/features/diagnosis-treatment/decision/watch-and-wait.mp3";
