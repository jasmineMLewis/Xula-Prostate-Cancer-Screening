...
export class StepOneComponent implements OnInit {
  ...
  public getTestedPlay(): void {
    this.getTestedAudio.src = "/assets/audio/features/prostate-screening/steps-involved/step-one-get-tested.mp3";
  ...
  public prostateExamPlay(): void {
    this.prostateExamAudio.src = "/assets/audio/features/prostate-screening/steps-involved/step-one-prostate-exam.mp3";
