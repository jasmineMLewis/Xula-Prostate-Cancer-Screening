...
export class InflammationComponent implements OnInit {
  ...
  public antibioticAntiInflammatoryPlay(): any {
    this.antibioticAntiInflammatoryAudio.src = 
      "/assets/audio/features/prostate-importance/common-problems/antibiotic-antiInflammatory.mp3";
  ...
  public inflammationPlay(): void {
    this.inflammationAudio.src = "/assets/audio/features/prostate-importance/common-problems/inflammation.mp3";
